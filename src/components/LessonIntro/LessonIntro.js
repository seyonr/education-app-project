...
//             <button
//                 onClick={startLesson}
//                 className="startLesson-btn"
//             >
//                 {savedQuestion > 0 ? "Continue Lesson" : "Start Lesson →"}
//             </button>
  ...
  return (
    <div className="context-page">
      ...
      <div className="context-container">
        {(lesson.context || []).map((item, index) => (
          <div key={index} className="context-card">
            <h2 className="context-term">{item.term}</h2>

            <p className="context-definition">{item.definition}</p>
      ...
      {lesson.tips && <div className="tip-box">💡 Tip: {lesson.tips}</div>}
